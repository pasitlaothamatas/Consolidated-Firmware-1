...
struct CellMonitor
{
    ...
    ExitCode (*read_internal_die_temperatures)(void);
    ...
    float max_pack_voltage)
{
    ...
    cell_monitor->read_internal_die_temperatures =
        read_internal_die_temperatures;
...
ExitCode App_CellMonitor_ReadInternalDieTemperatures(
    const struct CellMonitor *const cell_monitor)
{
    return cell_monitor->read_internal_die_temperatures();
}
